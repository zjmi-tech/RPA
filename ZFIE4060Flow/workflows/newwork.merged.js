...
//	if (ctx.options.isDebug) {
		...
		systray.addMenu('', '自动批量过账', '自动批量过账', '', function (ev) {
...
//	var command = 'sapgui.exe /SHORTCUT="-gui="'+ '192.168.145.14' +' ' + '01' +'" -SID='+'QAS'+' -client='+ '550'+' -user="'+'LINJ5'+'" -pw="'+'q673994886'+'" -l="ZH" -reuse=1 -max -connid=zjmirpa';
//	ctx.execRun(command,1,true);
...
GLOBAL.step({ Start_SAPLogon760_P: function(ev, sc, st) {
	...
	var command = 'sapgui.exe /SHORTCUT="-gui="'+ rootData.SAPLogon760Data.pSAPData.IP +' ' + '01' +'" -SID='+ rootData.SAPLogon760Data.pSAPData.SID +' -client='+ rootData.SAPLogon760Data.pSAPData.edClient +' -user="'+ rootData.SAPLogon760Data.pSAPData.edUser +'" -pw="'+ rootData.SAPLogon760Data.pSAPData.oPassword +'" -l="ZH" -reuse=1 -max -connid=zjmirpa';
	ctx.execRun(command,1,true);
